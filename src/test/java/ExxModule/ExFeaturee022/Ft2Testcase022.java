...
package ExxModule.ExFeaturee022;
...
public class Ft2Testcase022 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new MhLoginPage(driver).username,actions.getData("./Excel/managedata.xlsx","Sheet1",1,0));
        ...
        try
        {
            actions.EnterData(new MhLoginPage(driver).password,actions.getData("./Excel/managedata.xlsx","Sheet1",1,1));
